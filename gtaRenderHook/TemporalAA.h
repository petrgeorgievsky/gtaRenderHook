...
public:
	...
	static void Render(RwRaster* input, RwRaster* output, RwRaster* gBuff1, RwRaster* gBuff2);
private:
...
public:
	TAASettingsBlock() {
		...
		m_aFields["SubPixelCount"]				= new UIntSField("SubPixelCount", false, false, false, m_sName, 8, 2, 10, 1);
