...
D3D11_FILTER CD3D1XEnumParser::ConvertTextureFilterMode(RwTextureFilterMode mode)
{
	...
	case rwFILTERLINEAR:
	case rwFILTERLINEARMIPLINEAR:	return D3D11_FILTER_MIN_MAG_MIP_LINEAR;
	case rwFILTERMIPLINEAR:			return D3D11_FILTER_MIN_MAG_LINEAR_MIP_POINT;
	case rwFILTERLINEARMIPNEAREST:	return D3D11_FILTER_MIN_MAG_POINT_MIP_LINEAR;
...
RwTextureFilterMode CD3D1XEnumParser::ConvertTextureFilterMode(D3D11_FILTER mode)
{
	...
	case D3D11_FILTER_MIN_MAG_LINEAR_MIP_POINT:	return rwFILTERMIPLINEAR;
	case D3D11_FILTER_MIN_MAG_POINT_MIP_LINEAR:	return rwFILTERLINEARMIPNEAREST;
	case D3D11_FILTER_MIN_MAG_MIP_LINEAR:		return rwFILTERLINEARMIPLINEAR;
