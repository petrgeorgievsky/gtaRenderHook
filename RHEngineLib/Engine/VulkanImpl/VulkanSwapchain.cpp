...
SwapchainFrame VulkanSwapchain::GetAvaliableFrame( ISyncPrimitive *signal )
{
    ...
    auto vk_signal_prim = dynamic_cast<VulkanGPUSyncPrimitive *>( signal );
...
bool VulkanSwapchain::Present( SwapchainFrame &swapchain_img,
