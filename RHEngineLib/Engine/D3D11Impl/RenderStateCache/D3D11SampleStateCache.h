...
public:
   ...
   */
    void SetSamplerState( const std::vector<IndexPtrPair> &sampler_states, ShaderStage stages );
...
private:
    ...
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aPSSamplerStates{};
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aCSSamplerStates{};
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aGSSamplerStates{};
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aVSSamplerStates{};
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aDSSamplerStates{};
    std::array<uint64_t, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT> m_aHSSamplerStates{};
    ...
    uint32_t m_nMinDirtyIdPS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
    uint32_t m_nMinDirtyIdVS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
    uint32_t m_nMinDirtyIdGS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
    uint32_t m_nMinDirtyIdHS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
    uint32_t m_nMinDirtyIdDS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
    uint32_t m_nMinDirtyIdCS = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
};
}; // namespace rh::engine
