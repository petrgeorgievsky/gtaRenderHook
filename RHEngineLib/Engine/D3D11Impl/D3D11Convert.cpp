...
{
    switch ( format ) {
    case ImageBufferFormat::Unknown:
        return DXGI_FORMAT_UNKNOWN;
    case ImageBufferFormat::BC1:
        return DXGI_FORMAT_BC1_UNORM;
    case ImageBufferFormat::BC2:
        return DXGI_FORMAT_BC2_UNORM;
    case ImageBufferFormat::BC3:
        return DXGI_FORMAT_BC3_UNORM;
    case ImageBufferFormat::BC4:
        return DXGI_FORMAT_BC4_UNORM;
    case ImageBufferFormat::BC5:
        return DXGI_FORMAT_BC5_UNORM;
    case ImageBufferFormat::BC6H:
        return DXGI_FORMAT_BC6H_SF16;
    case ImageBufferFormat::BC7:
        return DXGI_FORMAT_BC7_UNORM;
    case ImageBufferFormat::RGBA32:
        return DXGI_FORMAT_R32G32B32A32_FLOAT;
    case ImageBufferFormat::RGB32:
        return DXGI_FORMAT_R32G32B32_FLOAT;
    case ImageBufferFormat::RGBA16:
        return DXGI_FORMAT_R16G16B16A16_FLOAT;
    case ImageBufferFormat::RGB10A2:
        return DXGI_FORMAT_R10G10B10A2_UNORM;
    case ImageBufferFormat::RG11B10:
        return DXGI_FORMAT_R11G11B10_FLOAT;
    case ImageBufferFormat::RGBA8:
        return DXGI_FORMAT_R8G8B8A8_UNORM;
    case ImageBufferFormat::RG32:
        return DXGI_FORMAT_R32G32_FLOAT;
    case ImageBufferFormat::RG16:
        return DXGI_FORMAT_R16G16_FLOAT;
    case ImageBufferFormat::RG8:
        return DXGI_FORMAT_R8G8_UNORM;
    case ImageBufferFormat::R32G8:
        return DXGI_FORMAT_R32G8X24_TYPELESS;
    case ImageBufferFormat::R32:
        return DXGI_FORMAT_R32_FLOAT;
    case ImageBufferFormat::R16:
        return DXGI_FORMAT_R16_UNORM;
    case ImageBufferFormat::R8:
        return DXGI_FORMAT_R8_UNORM;
    case ImageBufferFormat::B5G6R5:
        return DXGI_FORMAT_B5G6R5_UNORM;
    case ImageBufferFormat::BGR5A1:
        return DXGI_FORMAT_B5G5R5A1_UNORM;
    case ImageBufferFormat::BGRA8:
        return DXGI_FORMAT_B8G8R8A8_UNORM;
    case ImageBufferFormat::BGR8:
        return DXGI_FORMAT_B8G8R8X8_UNORM;
    case ImageBufferFormat::BGRA4:
        return DXGI_FORMAT_B4G4R4A4_UNORM;
    case ImageBufferFormat::A8:
...
String GetD3DShaderPrefix()
{
    ...
    case D3D_FEATURE_LEVEL_9_1:
        return TEXT( "4_0_level_9_1" );
    case D3D_FEATURE_LEVEL_9_2:
        return TEXT( "4_0_level_9_2" );
    case D3D_FEATURE_LEVEL_9_3:
        return TEXT( "4_0_level_9_3" );
...
GetD3D11DepthStencilState( const DepthStencilState &desc )
{
    ...
    ds_desc.DepthWriteMask = desc.enableDepthWrite ? D3D11_DEPTH_WRITE_MASK_ALL
    ...
    ds_desc.FrontFace.StencilFailOp = GetD3D11StencilOp( desc.frontFaceStencilOp.stencilFailOp );
    ds_desc.FrontFace.StencilDepthFailOp = GetD3D11StencilOp(
        desc.frontFaceStencilOp.stencilDepthFailOp );
    ds_desc.FrontFace.StencilPassOp = GetD3D11StencilOp( desc.frontFaceStencilOp.stencilPassOp );
    ds_desc.FrontFace.StencilFunc = GetD3D11ComparisonFunc( desc.frontFaceStencilOp.stencilFunc );

    // stencil operations if pixel is back-facing
    ds_desc.BackFace.StencilFailOp = GetD3D11StencilOp( desc.backFaceStencilOp.stencilFailOp );
    ds_desc.BackFace.StencilDepthFailOp = GetD3D11StencilOp(
        desc.backFaceStencilOp.stencilDepthFailOp );
    ds_desc.BackFace.StencilPassOp = GetD3D11StencilOp( desc.backFaceStencilOp.stencilPassOp );
    ds_desc.BackFace.StencilFunc = GetD3D11ComparisonFunc( desc.backFaceStencilOp.stencilFunc );
...
D3D11_BLEND GetD3D11BlendOp( const BlendOp &op )
{
    ...
    case BlendOp::InvSrcAlpha:
        return D3D11_BLEND_INV_SRC_ALPHA;
    case BlendOp::DestAlpha:
        return D3D11_BLEND_DEST_ALPHA;
    case BlendOp::InvDestAlpha:
        return D3D11_BLEND_INV_DEST_ALPHA;
    case BlendOp::DestColor:
        return D3D11_BLEND_DEST_COLOR;
    case BlendOp::InvDestColor:
        return D3D11_BLEND_INV_DEST_COLOR;
    case BlendOp::SrcAlphaSat:
...
{
    switch ( op ) {
    case BlendCombineOp::Add:
        return D3D11_BLEND_OP_ADD;
    case BlendCombineOp::Substract:
        return D3D11_BLEND_OP_SUBTRACT;
    case BlendCombineOp::RevSubstract:
        return D3D11_BLEND_OP_REV_SUBTRACT;
    case BlendCombineOp::Min:
        return D3D11_BLEND_OP_MIN;
    case BlendCombineOp::Max:
...
D3D11_BLEND_DESC GetD3D11BlendState( const BlendState &desc )
{
    ...
    for ( size_t i = 0; i < 8; i++ ) {
        bl_desc.RenderTarget[i] = GetD3D11PerRTBlendState( desc.perRTBlendState[i] );
    }
    return bl_desc;
}
