...
{
  public:
    VATAColorFilterPass( VarAwareTempAccumColorFilterPipe *pipeline,
  ...
  private:
    VarAwareTempAccumColorFilterPipe *mParent{};
    ...
    SPtr<rh::engine::IImageBuffer> mReProjectMomentsBuffer;
    SPtr<rh::engine::IImageView>   mReProjectMomentsView;
    ...
    SPtr<rh::engine::IImageBuffer> mAccumulateMomentsBuffer;
    SPtr<rh::engine::IImageView>   mAccumulateMomentsView;
...
class VarAwareTempAccumColorFilterPipe
{
  ...
  private:
    ...
    friend class VATAColorFilterPass;
};
} // namespace rh::rw::engine